    ...
    def create_type_kind_conversion_map__(self) -> Dict[ClangCursorType, TokenKind]:
        ...
        conversion_map[
            (
                ...
                ClangCursorType.UINT,
                ClangCursorType.ULONG,
                ClangCursorType.ULONGLONG,
                ClangCursorType.UINT128,
                ClangCursorType.SHORT,
                ClangCursorType.INT,
                ClangCursorType.LONG,
                ClangCursorType.LONGLONG,
                ClangCursorType.INT128,
            )
        ] = VariableTokenKind.Numeric
        conversion_map[(ClangCursorType.FLOAT, ClangCursorType.DOUBLE, ClangCursorType.LONGDOUBLE)] = VariableTokenKind.FloatingPoint
        ...
        conversion_map[(ClangCursorType.CONSTANTARRAY, ClangCursorType.VARIABLEARRAY, ClangCursorType.DEPENDENTSIZEDARRAY)] = VariableTokenKind.Array
        return conversion_map
